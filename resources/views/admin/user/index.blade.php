                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($user as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a href="{{$item->avatar}}" data-toggle="lightbox">
                                                        <img src="{{$item->avatar}}"
                                                            alt="pas d'image">
                                                    </a>
                                                </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list px-4">
                                                        <a href="{{ url('/admin/user/' . $item->id) }}" title="Detail Utilisateur"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                                        <a href="{{ url('/admin/user/' . $item->id . '/edit') }}" title="Modifier Utilisateur"><button class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></button></a>
