<div class="form-group {{ $errors->has('type_category_id') ? 'has-error' : ''}}">
    ...
    <a href="#" class="btn-block" style="color: blue;font-size:13px;font-family:consolas;font-style:italic"
...
<div class="form-group {{ $errors->has('type_category_id') ? 'has-error' : ''}}">
    <label for="type_category_id" class="control-label">{{ 'Phase Id' }}</label>
