            ...
            <div class="col-md-12">
                <div class="card">
                                <div class="card-header">
                                    ...
                                    <a style="float:right;" href="{{ url('/admin/cours/create') }}" class="btn btn-success btn-sm" title="Add New Cour">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                    <tr>
                                        <th>#</th><th>Nom</th><th>Temps</th><th>Numero</th><th class="datatable-nosort">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a href="{{ url('/admin/cours/' . $item->id) }}" title="Détail Cour"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Détail</button></a>
