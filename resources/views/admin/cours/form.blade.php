...
<div class="form-group {{ $errors->has('activated') ? 'has-error' : ''}}">
    ...
    <div class="radio">
    <label><input name="activated" type="radio" value="1" {{ (isset($cour) && 1 == $cour->activated) ? 'checked' : '' }}> Yes</label>
</div>
<div class="radio">
...
<div class="form-group {{ $errors->has('finish') ? 'has-error' : ''}}">
    ...
    <div class="radio">
    <label><input name="finish" type="radio" value="1" {{ (isset($cour) && 1 == $cour->finish) ? 'checked' : '' }}> Yes</label>
</div>
<div class="radio">
...
<div class="form-group {{ $errors->has('created_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="created_id" type="number" id="created_id" value="{{ isset($cour->created_id) ? $cour->created_id : ''}}" >
