                                            ...
                                            <div class="card direct-chat direct-chat-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="direct-chat-messages">
                                                        ...
                                                        <div class="direct-chat-msg">
                                                            <div class="direct-chat-infos clearfix">
                                                                <span class="direct-chat-name float-left">{Robbot}</span>
                                                            </div>
                                                            <img class="direct-chat-img" src="{{ url(isset(Auth::user()->avatar) ? 'storage/' . Auth::user()->avatar : 'photo.jfif') }}" alt="message user image">
                                                            <div class="direct-chat-text">
                                                                <b style="color: red">
                            ...
                            <div class="row">
                                <div class="row col-12">
                                    <div class="card ">
                                        <div class="row g-0 ">
                                            <div class="card-body">
                                                <h5 class="card-title"><b>Nous n'avons pas encore de vidéos pour ce cours</h5>
                                                <p class="card-text"> Veillez s'il vous plait patienter que les administratuer mettent à jours les donnée de ce cours</p>
                                                <p class="card-text text-center">
                                                    <a href="{{url('/user/cours')}}" class="btn btn-warning row">
                                                        <i class="fas fa-arrow-left">Retour au choix d'un autre cours</i>
                                                    </a>
                                                </p>
                                            </div>
                                        </div>
