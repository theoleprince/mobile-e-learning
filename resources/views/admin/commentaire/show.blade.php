                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Commentaire </th><td> {{ $commentaire->commentaire }} </td></tr><tr><th> Phase </th><td> {{ $commentaire->_titre }} </td></tr><tr><th> Personne Ayant Posté </th><td> {{ $commentaire->_name.' '.$commentaire->_prenom }} (<a href="mailto:{{$commentaire->_email}}"><strong>{{$commentaire->_email}}</strong></a>)</td></tr>
                                </tbody>
                            </table>
                        </div>
