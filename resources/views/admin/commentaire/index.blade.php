            ...
            <div class="col-md-12">
                <div class="card">
                                <div class="card-header">
                                    ...
                                    <a style="float:right;" href="{{ url('/admin/commentaire/create') }}" class="btn btn-success btn-sm" title="Add New Commentaire">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                    <tr>
                                        <th>#</th><th>Commentaire</th><th>Phase Id</th><th>User Id</th><th class="datatable-nosort">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a href="{{ url('/admin/commentaire/' . $item->id) }}" title="Détail Commentaire"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Détail</button></a>
