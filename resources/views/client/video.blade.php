                            ...
                            <div class="row col-12">
                                <div class="card col-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">{{$item->_categorie}}</p>
                        ...
                        <div class="row">
                            <div class="row col-12">
                                <div class="card ">
                                    <div class="row g-0 ">
                                        <div class="card-body">
                                            <h5 class="card-title"><b>Nous n'avons pas encore de vidéos disponible</h5>
                                            ...
                                            <p class="card-text text-center">
                                                <a href="{{url('/home')}}" class="btn btn-warning row">
                                                    <i class="fas fa-arrow-left">Retournez a la page d'accueil</i>
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <a class="nav-link" id="vert-tabs-right-{{$item->id}}-tab" data-toggle="pill"
                            ...
                            <div class="card m-1">
                                <div class="row g-0 m-1">
                                    <div class="card-body">
                                        <h5 class="card-title"><b>({{$item->minute}})</b> {{$item->nom}}</h5>
                                        <p class="card-text"> {{$item->_categorie}}</p>
                                        <p class="card-text">
